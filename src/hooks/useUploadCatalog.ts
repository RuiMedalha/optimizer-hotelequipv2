...
export const DEFAULT_PRODUCT_FIELDS: ProductField[] = [
  ...
  { key: "technical_specs", label: "Especificações Técnicas", required: false },
  { key: "price", label: "Preço", required: false },
  { key: "original_price", label: "Preço de Custo", required: false },
  ...
  { key: "supplier_url", label: "URL Fornecedor", required: false },
  { key: "image_urls", label: "Imagens", required: false },
  { key: "image_alt_texts", label: "Alt Text Imagens", required: false },
  { key: "stock", label: "Stock", required: false },
  { key: "disponibilidade", label: "Disponibilidade", required: false },
  { key: "attributes", label: "Atributos", required: false },
  { key: "attributes", label: "Peso", required: false },
  { key: "attributes", label: "Dimensões", required: false },
  { key: "weight", label: "Peso (Original)", required: false },
  { key: "dimensions", label: "Dimensões (Original)", required: false },
  { key: "model", label: "Modelo", required: false },
  { key: "video_url", label: "Video URL", required: false },
  { key: "certifications", label: "Certificações", required: false },
  { key: "seo_slug", label: "Slug SEO", required: false },
  { key: "tags", label: "Tags", required: false },
  { key: "is_discontinued", label: "Descontinuado", required: false },
  { key: "min_order_quantity", label: "Qtd. Mínima Venda", required: false },
